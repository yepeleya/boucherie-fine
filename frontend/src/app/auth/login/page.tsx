        ...
        >
          <div className="max-w-md w-full">
            ...
            <motion.div
              ...
              className="mb-6 p-4 auth-success rounded-xl"
            >
              <h3 className="font-semibold text-restaurant-primary mb-2 text-sm flex items-center">
                🧪 Comptes de test disponibles
              </h3>
              <div className="text-xs auth-text-muted space-y-1">
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
                <motion.div
                  ...
                  className="auth-card rounded-xl p-4"
                >
                  <div className="text-2xl mb-2">🥩</div>
                  <h3 className="font-semibold auth-card-text">Viandes Premium</h3>
                </motion.div>
                <motion.div
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                ...
                >
                  ...
                  <h3 className="font-semibold auth-card-text">Réservations</h3>
                </motion.div>
                <motion.div
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                ...
                >
                  <div className="text-2xl mb-2">🚚</div>
                  <h3 className="font-semibold auth-card-text">Livraison</h3>
                </motion.div>
              </div>
            </motion.div>
          </div>
