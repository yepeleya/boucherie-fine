      ...
      <div className="flex-1 flex">
        ...
        >
          ...
          <div className="relative z-10 flex items-center justify-center p-12">
            ...
            <p className="text-xl auth-card-text mb-8 leading-relaxed">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <motion.div
                ...
                className="auth-card rounded-xl p-6 text-center"
              >
                <div className="text-3xl mb-3">👥</div>
                <h3 className="font-semibold text-lg mb-2 auth-card-text">Communauté Exclusive</h3>
                <p className="text-sm auth-card-subtitle">Accès prioritaire aux nouveautés</p>
              </motion.div>
              ...
              >
                <div className="text-3xl mb-3">🎁</div>
                <h3 className="font-semibold text-lg mb-2 auth-card-text">Offres Spéciales</h3>
                <p className="text-sm auth-card-subtitle">Promotions membres exclusives</p>
              </motion.div>
              ...
              >
                <div className="text-3xl mb-3">📱</div>
                <h3 className="font-semibold text-lg mb-2 auth-card-text">Gestion Facile</h3>
                <p className="text-sm auth-card-subtitle">Commandes et réservations simplifiées</p>
              </motion.div>
              ...
              >
                <div className="text-3xl mb-3">⭐</div>
                <h3 className="font-semibold text-lg mb-2 auth-card-text">Service Premium</h3>
                <p className="text-sm auth-card-subtitle">Support client personnalisé</p>
              </motion.div>
            </div>
          </motion.div>
        </div>
        ...
        <div className="max-w-md w-full">
          ...
          >
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <button
                    ...
                    className="absolute inset-y-0 right-0 pr-4 flex items-center auth-text-subtle hover:text-restaurant-primary transition-colors"
                  >
                    {showPassword ? (
            ...
            <motion.button
              ...
              type="submit"
              disabled={isLoading}
              className="btn-primary-force btn-force-visible w-full py-4 px-6 rounded-xl font-semibold text-lg transform disabled:opacity-50 disabled:transform-none flex items-center justify-center space-x-2 shadow-lg hover:shadow-xl"
            >
              {isLoading ? (
            ...
            <div className="text-center space-y-4">
              <div className="flex items-center justify-center">
                <div className="border-t auth-border-subtle flex-grow"></div>
                <span className="px-4 auth-text-subtle text-sm font-medium">ou</span>
                <div className="border-t auth-border-subtle flex-grow"></div>
              </div>
              ...
              <Link 
                href="/" 
                className="inline-block auth-text-light hover:text-restaurant-primary text-sm transition-colors"
              >
                ← Retour à l&apos;accueil
              </Link>
            </div>
